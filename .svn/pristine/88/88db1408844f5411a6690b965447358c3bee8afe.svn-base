...
<link rel="stylesheet" type="text/css" href="${ctx}/source/css/himall/edit_video.css"/>
           ...
           <div style="overflow: hidden;<c:if test='${video!=null && video.checkState==0 }'>display:none;</c:if>">
             ...
             <div class="jcfw-images">
              ...
              <div id = "show_big_img" class="jcfw-bigImg">
              	<img alt="剪裁范围" src="${imgpre }${video==null?'':video.imgMin }" id = "cover_img_big" ${video==null?'style="display:none;"':'' }></img>

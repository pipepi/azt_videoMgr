      ...
      <div class="video-tabs"><!--video-tabs Begin-->
         <div class="video-tabs-cons">
            ...
            <div class="choice-type" style="display:none">
               ...
               <ul>
                  <li><input type="radio"  name="payType" value="1"  checked="checked" class="zhifu-images"/><img src="${ctx }/source/images/himall/zfb.jpg" width="126" height="36" /></li>
                  <li><input type="radio"  name="payType" value="4" class="zhifu-images"/><img src="${ctx }/source/images/himall/weibo.jpg" width="126" height="36" /></li>
               </ul>

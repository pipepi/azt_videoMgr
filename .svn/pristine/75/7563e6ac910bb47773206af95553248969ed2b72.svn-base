            ...
            <div class="table-responsive">
                <table class="table table-hover table-striped table-bordered" id="j-table">
                    ...
                    <tr>
                        ...
                        <th data-sorttype="name">商品名</th>
                        <th data-sorttype="photoUrl1">LOGO</th>
                        <th data-sorttype="type">类型</th>
                        <th data-sorttype="price">价格</th>
                        <th data-sorttype="weight">重量</th>
                        <th data-sorttype="reserve">库存</th>
    ...
    var tabl = $("#j-table").dataTable({
        ...
        "aoColumns":[	//参数用来定义表格的列，这是一个数组
            ...
            },
            {
                ...
                "sClass":"dropdown text-left",
                "render": function(data){
                	return data > 10 ? "有货" : (data < 0 ? "无货" : "缺货");
                }
            },
            {
            	"mData":"status",

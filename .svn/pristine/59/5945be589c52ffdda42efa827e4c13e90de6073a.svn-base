...
<div class="container-fluid">
    <form:form class="form-horizontal" commandName="productOrder" modelAttribute="productOrder" data-widget="validator" data-item-class="form-group" data-item-error-class="has-error" data-explain-class="j-explain" role="form" action="${rootpath}/${productOrder.id > 0 ? 'savelog' : 'save' }">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">编辑物流</h3>
            </div>
            <div class="panel-body ">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="j-email">物流公司</label>
                    <div class="col-sm-6">
                        <select class="form-control " id="j-select" required data-rule="text"  placeholder="下拉" name="logisticsCompany" <c:if test="${productOrder.deliverStatus > 0}">readonly=\"true\"</c:if>>
                            ...
                            <option value="zhongyouwuliu" >中友物流</option>
                        </select>
                    </div>
                    <div class="col-sm-4 control-label j-explain" style="text-align:left;font-style:italic;font-size:12px;color:red;">
                    </div>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="j-email">物流单号</label>
                    <div class="col-sm-6">
                        <input class="form-control " id="j-email" name="logisticsNum" type="text" value="${productOrder.logisticsNum}" placeholder="物流单号" <c:if test="${productOrder.deliverStatus > 0}">readonly=\"true\"</c:if>/>
                    </div>
                    <div class="col-sm-4 control-label j-explain" style="text-align:left;font-style:italic;font-size:12px;color:red;">
                    </div>
                </div>

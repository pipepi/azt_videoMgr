      ...
      <div class="voideo-add2" style="margin-top:0"><!--voideo-add2 Begin-->
        <table cellpadding="7" cellspacing="0" border="0" class="wuliu-tabs">
            ...
            <tr>
                ...
                <td><div class="inputs-text-ps" style="overflow: hidden;height: 60px;">${productOrder.toProvince }${productOrder.toCity }${productOrder.toArea }${productOrder.toAddress }</div></td>
            </tr>
            <tr>
            ...
            <tr>
            	...
            	物流单号</td>
                <td><input id="logistics-num" maxlength="36" type="text" class="inputs-text-p" value="${productOrder.logisticsNum}"  <c:if test="${productOrder.deliverStatus > 0}">readonly=\"true\"</c:if> ></td>
            </tr>
        </tbody></table>

...
<div class="container-fluid">
    <form:form class="form-horizontal" commandName="productOrder" modelAttribute="productOrder" data-widget="validator" data-item-class="form-group" data-item-error-class="has-error" data-explain-class="j-explain" role="form" action="${rootpath}/${productOrder.id > 0 ? 'testUpdate' : 'save' }">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">测试订单状态&送货状态</h3>
            </div>
            <div class="panel-body ">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control " id="j-email" value="${productOrder.price }" name="price" onKeyUp="this.value=this.value.replace(/[^\.\d]/g,'');"  type="text" placeholder="价格" readonly="true" />
                    </div>
                    <div class="col-sm-4 control-label j-explain" style="text-align:left;font-style:italic;font-size:12px;color:red;">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control " id="j-email" value="${deliverStatus[productOrder.deliverStatus] }" name="deliverStatus" type="text" placeholder="收货状态" >
                    </div>
                    <div class="col-sm-4 control-label j-explain" style="text-align:left;font-style:italic;font-size:12px;color:red;">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <label class="radio-inline">
                            <input type="radio" name="status" id="inlineRadio1" value="0" <c:if test="${productOrder.orderStatus == 0 }">checked</c:if>> 未付款
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="status" id="inlineRadio2" value="1" <c:if test="${productOrder.orderStatus == 1 }">checked</c:if>> 已付款
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="status" id="inlineRadio3" value="2" <c:if test="${productOrder.orderStatus == 2 }">checked</c:if>> 完成
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="status" id="inlineRadio4" value="3" <c:if test="${productOrder.orderStatus == 3 }">checked</c:if>> 关闭
                        </label>
                    </div>

   ...
   <!--数据流量选择配置-->
     ...
     <div class="choice-type2" style="display:none" id ="payDiv">
        ...
        <ul>
           ...
           <li><input type="radio"  type="radio" name="payType" value="3"   style=" vertical-align:top;margin-top:20px;margin-right:10px;"/><img src="${ctx}/source/images/himall/package/weibo.jpg" width="126" height="36" /></li>
        </ul>

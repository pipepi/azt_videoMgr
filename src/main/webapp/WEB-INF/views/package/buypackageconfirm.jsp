...
<div class="sj_buy-video">
   <div class="sj-buy-videoCons">
     <img src="${ctx}/source/images/himall/package/jdt_2.jpg" width="885" height="62" />
     <ul class="tjt-font">
    ...
    <div>
     ...
     <div id="choosePayTypeDiv" class="choice-type" style="display: none">
        ...
        <ul>
           <li><input type="radio" name="payType"  value="1" checked="checked" style=" vertical-align:top;margin-top:20px;margin-right:10px;"/><img src="${ctx}/source/images/himall/package/zfb.jpg" width="126" height="36" /></li>
           <li><input type="radio" name="payType" value="3"   style=" vertical-align:top;margin-top:20px;margin-right:10px;"/><img src="${ctx}/source/images/himall/package/weibo.jpg" width="126" height="36" /></li>
        </ul>

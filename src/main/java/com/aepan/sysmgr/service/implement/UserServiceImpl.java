...
public class UserServiceImpl implements UserService {
	...
	/* (non-Javadoc)
	 * @see com._aepan.sysmgr.service.UserService#findUserByHimallName(java.lang.String)
	 */
	@Override
	public List<User> findUserByHimallName(String himallName) {
		// TODO Auto-generated method stub
		return userDao.findUserByPartnerAccountName(himallName);
	}

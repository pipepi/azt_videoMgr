...
public class OrderDaoImpl implements OrderDao {
	...
	public PageList<ProductOrder> getList(Map<String, Object> params,
        ...
        sb.append(" o.to_address, o.to_mobile, o.order_status, o.to_mail, o.to_zip_code, o.back_mobile,o.back_mail,o.back_address,o.deliver_status, o.pay_type, o.pay_for, o.to_province,o.to_city,o.to_area,");
	...
	public ProductOrder getById(int id) {
		return jdbcTemplate.queryForObject(" select o.id, o.channel_id, o.order_id,o.out_order_id, o.buyers_id, "
				+ " o.buyers_name,o.buyers_delete, o.seller_id, o.seller_name, o.product_id, o.product_name, o.amount,o.price, o.to_province,o.to_city,o.to_area,o.to_address,o.back_mobile,o.back_mail,o.back_address, "
	...
	public PageList<ProductOrder> getMobileList(Map<String, Object> params,
        ...
        sql.append(" o.to_address, o.to_mobile, o.order_status, o.to_mail, o.to_zip_code, o.deliver_status, o.pay_type, o.pay_for, o.to_province,o.to_city,o.to_area,o.back_mobile,o.back_mail,o.back_address,");
        ...
        params.put("payFor", 1);//只查询购买商品生成的订单
	...
	public boolean isMobile(String mobile) {
		int ret = jdbcTemplate.query(" select o.id, o.channel_id, o.order_id, o.out_order_id,o.buyers_id, "
				...
				+ " o.to_mobile, o.order_status, o.deliver_status,  o.to_mail, o.to_zip_code, o.pay_type, o.back_mobile,o.back_mail,o.back_address,o.pay_for, o.logistics_num, o.logistics_company, "
